...
\aspas{ } útil para espaço em branco nos códigos, tipo isso
...
\begin{figure}[ht]
	\begin{minipage}[b]{0.45\linewidth}
		\centering
		\includegraphics[width=\textwidth]{imagens/exemplo.jpg}
		\caption{default}
		\label{fig:figure1}
	\end{minipage}
	\hspace{0.5cm}
...
Isso foi com base no livro \cite{knuth}.  Consulte \citeonline{publicacao} para mais informações.
%--------------------------------------------------------------------------
% REFERÊNCIAS
%--------------------------------------------------------------------------
