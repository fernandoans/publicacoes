...
\definecolor{backcolor}{RGB}{27,161,226}
\definecolor{fontcolor}{RGB}{30,64,35}
...
\lstset {
	aboveskip=3mm,
	backgroundcolor=\color{backcolor!5},
...
\newtheoremstyle{celulabox}% % Theorem style name
	{\topsep} % Space above
	{\topsep} % Space below
	{\ttfamily} % Body font
	{} % Indent amount
	...
	{\thmnote{}} % Theorem text (e.g. Theorem 2.1)
...
\theoremstyle{celulabox}
\newtheorem{algorithmT}{}

\theoremstyle{blacknumbox}
\newtheorem{noteT}{Dica}[chapter]

%----------------------------------------------------------------------------------------
%	DEFINITION OF COLORED BOXES
%----------------------------------------------------------------------------------------
\definecolor{ocre}{RGB}{243,102,25} % Define the orange color used for highlighting throughout the book
\definecolor{lightblue}{RGB}{27,161,226} % Define the orange color used for highlighting throughout the book
...
\newenvironment{note}{\begin{noteBox}\begin{noteT}}{\end{noteT}\end{noteBox}}
\newenvironment{celula}{\begin{celulaBox}\begin{algorithmT}}{\end{algorithmT}\end{celulaBox}}	
%------------------------------------------------------------------------------------
%	REMARK ENVIRONMENT
%------------------------------------------------------------------------------------
