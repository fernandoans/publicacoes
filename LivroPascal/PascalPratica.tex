...
\draw ([yshift=10cm]current page.center) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering Pascal na Prática\\[15pt] % Titulo
...
\noindent Copyright \copyright\ 2025 Fernando Anselmo - v1.0 % Copyright
...
\draw (current page.center) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering Pascal na Prática\\[15pt] % Titulo
