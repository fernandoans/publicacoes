...
\begin{figure}[H]
	\centering\includegraphics[scale=0.4]{cap01/Arquitetura}
...
\begin{figure}[H]
	\centering\includegraphics[scale=0.4]{cap01/ImagensDocker}
...
\begin{figure}[H]
	\centering\includegraphics[scale=0.3]{cap01/JupyterLab}
